define(function(require) { 
  ...
  function startReactionServerEvents() { 
    var source = new EventSource("https://streaming-graph.facebook.com/" + liveVideoId + "/live_reactions?access_token=" + accessToken + "&comment_rate=one_per_two_seconds&fields=from{name,id},message");
